...
import { generateSpeakerSlug } from "@/lib/utils"
...
export function SpeakerCard({ speaker }: SpeakerCardProps) {
  return (
    <Link
      ...
      params={{ speakerId: generateSpeakerSlug(speaker.name) }}
      ...
      <div className="flex items-center justify-center gap-4">
        {speaker.socialMedia.linkedin && (
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-brand-red/10 to-brand-red/5 transition-all hover:from-brand-red hover:to-brand-red-dark hover:shadow-lg hover:shadow-brand-red/30"
